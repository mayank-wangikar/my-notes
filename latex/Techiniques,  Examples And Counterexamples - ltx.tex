...
\begin{itemize}
    ...
    \begin{definition}\label{def:submodule}
        A subset $N$ of a module $(M, R, +)$ is called a submodule if
        \begin{enumerate}
            \item $N$ is a subgroup of $(M, +)$,
            \item For any $r \in R$ and $m \in M$, $r m \in N$.
        \end{enumerate}
        Verify the axioms.
    \end{definition}
...
\begin{tabular}{|l|l|l|}
\hline
\textbf{Finitely generated and cyclic modules} & & \\ \hline
...
An abelian group $G$ treated as a $\mathbb{Z}$-module is \textit{finitely generated} as a group.
\end{definition}

\begin{definition}\label{def:cyclic_group}
An abelian group $G$ treated as a $\mathbb{Z}$-module is \textit{cyclic} as a group.
\end{definition}

\begin{definition}\label{def:finitely_generated_ideal}
Let $R$ be a commutative ring and $M$ an ideal of $R$ such that $M$ is an $R$-module. $M$ is \textit{finitely generated} as an ideal.
\end{definition}

\begin{definition}\label{def:principal_ideal}
Let $R$ be a commutative ring and $M$ an ideal of $R$ such that $M$ is an $R$-module. $M$ is a \textit{principal ideal}.
\end{definition}
...
\begin{itemize}
    ...
    \begin{definition}\label{def:ring_module_hom}
