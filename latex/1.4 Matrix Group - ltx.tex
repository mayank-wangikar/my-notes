...
$\alpha$, $\beta$ (denoted $\alpha \beta$) with corr. matrices $(a_{ij})$, $(b_{ij})$
...
\[ \tau_{M_n(\mathbb{C})} = \{ f^{-1}(CU) \mid U \in \tau_{\mathbb{C}^n \times \mathbb{C}^n} \} \]
\end{remark}
...
\textbf{Pf:} $\quad M_n(\mathbb{C}) \times M_n(\mathbb{C}) \xrightarrow{q} M_n(\mathbb{C})$
...
\]
\[
\frac{d(\alpha \beta)}{dt} = \dot{\alpha} \cdot \beta
\]
...
(ii) then \( ^t (\sigma^{-1}) = (^t \sigma)^{-1} \), \( (\sigma^{-1})^t = (\sigma^t)^{-1} \)
...
\begin{remark}
$GL_n(\mathbb{C}) = \{\sigma \in M_n(\mathbb{C}) \mid \text{det} \sigma \neq 0 \}$
\[
= M_n(\mathbb{C}) \setminus \text{det}^{-1}\{0\}
\]
...
\[
\text{O}_n(\mathbb{C}C) = \left\{ \sigma \in GL_n(\mathbb{C}C) \mid \sigma^* = \sigma \right\}
\]
...
\[
\text{O} \quad U_n(\mathbb{C}C) = \left\{ \sigma \in GL_n(\mathbb{C}C) \mid \sigma^* = \bar{\sigma} \right\}
\]

is set of all unitary matrices.

Note $U_n(\mathbb{C}C)$ or $O_n(\mathbb{C}C)$ are non empty as $E \in U_n(\mathbb{C}C)$ and $E \in O_n(\mathbb{C}C)$.

Notation: $U_n(\mathbb{C}C) = (UCn)$ and $O_n(\mathbb{R}) = OCn$.
...
% --- Page 12 ---
$SL_n(\mathbb{C}) = \left\{ \sigma \in GL_n(\mathbb{C}) \mid \det \sigma = 1 \right\}$
...
\[ ^t \overline{\sigma} \sigma = \epsilon \leftrightarrow \sum_{k} a_{ki} \overline{a_{kj}} = \delta_{ij} \]
\end{proof}
...
Now in $(C^{n^2}, || \cdot ||)$ , $v = (v_k)_{k=1}^{n^2}$, $|v_k| \leq 1$ for $1 \leq k \leq n^2$ we define $||v|| = \max_{1 \leq k \leq n^2} |v_k|$.
