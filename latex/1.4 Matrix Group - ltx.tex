...
Notation: \( ^t A \) is transpose of a matrix and
\( \overline{A} \) is complex conjugate of a matrix.
...
\]
\[
\frac{d(\alpha \beta)}{dt} = \dot{\alpha} \cdot \beta + \alpha \cdot \dot{\beta}
\]
...
\item then \( ^t (\sigma^{-1}) = (^t \sigma)^{-1} \), \( (\bar{\sigma})^{-1} = (\bar{\sigma^{-1}}) \)
\end{enumerate}
\end{remark}
...
is set of \underline{orthogonal matrices}. If $\sigma = \sigma^*$ then $\sigma$ is \underline{complex orthogonal} and if $\sigma = \sigma^* = \overline{\sigma}$ then \underline{real orthogonal}.

$\mathrm{O}_n(\mathbb{R}) = \left\{ \sigma \in \mathrm{GL}_n(\mathbb{R}) \mid \sigma^T = \sigma^{-1} \right\}$

$\mathrm{U}_n(\mathbb{C}) = \left\{ \sigma \in \mathrm{GL}_n(\mathbb{C}) \mid \sigma^* = \sigma^{-1} \right\}$
...
Notation: $\mathrm{U}_n(\mathbb{C}) = (\mathrm{UC}n)$ and $\mathrm{O}_n(\mathbb{R}) = \mathrm{OC}n$.
