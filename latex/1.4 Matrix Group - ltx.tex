...
\begin{lemma}
\label{lem:transpose_conjugate_homeo}
...
$\mathrm{U}_n(\mathbb{C}) = \left\{ \sigma \in \mathrm{GL}_n(\mathbb{C}) \mid \sigma^* = \overline{\sigma} \right\}$

is set of all unitary matrices.

Note $\mathrm{U}_n(\mathbb{C})$ or $\mathrm{O}_n(\mathbb{C})$ are non empty as $\mathbb{I} \in \mathrm{U}_n(\mathbb{C})$ and $\mathbb{I} \in \mathrm{O}_n(\mathbb{C})$.
...
The sets $_{n \leq \sigma | \overline{\sigma} = \sigma^*}$ and $_{n \leq \sigma | \sigma = \sigma^*}$ are closed sets. Observe $GL_n(\mathbb{R}) = \{\sigma | \sigma = \overline{\sigma}\}$ is also closed. Hence $U(n)$ and
