...
\begin{tikzpicture}[baseline=(current bounding box.center)]
    % Left diagram: Circle with lines
    \draw[->] (-2,0) -- (0,0);
    \draw[->] (0,-2) -- (0,0);
    ...
    \filldraw[red] (-1,0) circle (1.5pt);
    % Right diagram: Half circle
    \draw[->] (3,0) -- (5,0);
    \draw[->] (4,-2) -- (4,0);
    \draw[thick] (3.5, -1.5) arc (300:60:1.5cm);
...
\begin{tikzpicture}[scale=0.5]
    ...
    % The image shows a sphere and a line through the origin, with points \(P(x, -y, -z)\) and \(Q(x, y, z)\).
\end{tikzpicture}
\]
...
\begin{enumerate}
    ...
    \begin{center}
        \begin{tikzpicture}[baseline=(current bounding box.center)]
            ...
            \node[above] at (0,1.5) {$\varphi_2$};
            \node[below] at (0,-1.5) {$\varphi_1$};
            \node[left] at (-1.5,0) {$U_2$};
            \node[right] at (1.5,0) {$U_1$};
            \node[below] at (0,-2) {$S$};
            \node[above] at (0,2) {$\mathbb{R}^2$};
            \filldraw (0,0) circle (1pt) node[above right] {n};
        \end{tikzpicture}
    \end{center}
\end{enumerate}
\end{example}
...
\begin{tikzpicture}[scale=0.5]
    ...
    \draw[->] (0,0,0) -- (0,3,0);
    \draw[->] (0,0,0) -- (0,0,3);
    \draw[fill=yellow, yellow!20] (0,0,0) -- (2,2,0) -- (2,0,2) -- (0,0,0);
    \draw[fill=yellow, yellow!20] (0,0,0) -- (2,2,0) -- (0,2,2) -- (0,0,0);
    \draw[orange, thick, ->] (0,0,0) -- (2,2,0) node[anchor=south west]{$OA$};
    \draw[orange, thick, ->] (0,0,0) -- (0,2,2) node[anchor=north east]{$OB$};
\end{tikzpicture}
\]
...
\draw[blue,thick,->] (-2.5,-2.5) -- (-2,-2);
\draw[blue,thick,->] (-2,-2) -- (-1.5,-1.5);
\draw[blue,thick,->] (-1.5,-1.5) -- (-1,-1);
\draw[blue,thick,->] (-1,-1) -- (-0.5,-0.5);
\draw[blue,thick,->] (-0.5,-0.5) -- (0,0);
\draw[blue,thick,->] (0,0) -- (0.5,0.5);
\draw[blue,thick,->] (0.5,0.5) -- (1,1);
\draw[blue,thick,->] (1,1) -- (1.5,1.5);
\draw[blue,thick,->] (1.5,1.5) -- (2,2);
...
\draw[blue,thick,->] (-1,0) -- (-0.5,0);
\draw[blue,thick,->] (0.5,0) -- (1,0);
\draw[blue,thick,->] (1,0) -- (1.5,0);
\draw[blue,thick,->] (1.5,0) -- (2,0);
\draw[blue,thick,->] (0,2.5) -- (0,2);
\draw[blue,thick,->] (0,2) -- (0,1.5);
\draw[blue,thick,->] (0,1.5) -- (0,1);
\draw[blue,thick,->] (0,0.5) -- (0,0);
\draw[blue,thick,->] (0,-0.5) -- (0,-1);
\draw[blue,thick,->] (0,-1) -- (0,-1.5);
\draw[blue,thick,->] (0,-1.5) -- (0,-2);
\draw[blue,thick,->] (0,-2.5) -- (0,-2);
\end{tikzpicture}
\end{center}
